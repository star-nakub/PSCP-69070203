...
```text
โจทย์ให้ เขียนโปรแกรมแสดงฤดูกาล

Input:
โปรแกรมรับค่าเดือนและวัน

Output:
เดือนที่หาร 3 ลงตัวและเป็นวันที่มากกว่า 21 ให้เปลี่ยนฤดูไปข้างหน้า 1 ถ้าไม่ใช่ตามเงื่อนไขให้แสดงตามฤดูกาล
```
...
```text
Step 1: อ่านค่าเดือนกับวัน
Step 2: ตรวจว่า เดือนหาร 3 ลงตัวมั้ย
Step 3: ถ้าจริง ให้เช็คว่าเป็นวันที่มากกว่า 21 หรือไม่
Step 4: ถ้าไม่จริงแสดงฤดูตามวัน
```
...
```text
เพราะเป็นเดือนที่ 12 มีสิทธิ์ error สูง
```
