...
```text
โจทย์ให้เปลี่ยนค่าอุณหภูมิเป็นหน่วยที่กำหนด

Input:
โปรแกรมรับค่าแรกเป็นอุณหภูมิ ค่าสองคือ หน่วยของอุณหภูมิ ค่าที่สามคือ หน่วยของอุณหภูมิที่ต้องเปลี่ยน

Output:
เป็นอุณหภูมิ ตามค่าที่สามให้ตอบทศนิยม 2 ตำแหน่ง

Constraints:
เปลี่ยนทันทีเลยไม่ได้ต้องเป็นองศาแล้วค่อยเปลี่ยนเพื่อไม่ใช้ if else มากเกิน
```
...
```text
Step 1: รับ input อุณหภูมิ หน่วยอันแรก และหน่วยที่จะเปลี่ยน
Step 2: แปรหน่วยเป็นองศาเซลเซียส
Step 3: แปรเป็นหน่วยที่จะเปลี่ยน
Step 4: แสดงผลจำนวนจริง เป็นอุณหภูมิ ตามหน่วยที่จะเปลี่ยนตอบทศนิยม 2 ตำแหน่ง
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก โดยเปลี่ยนเป็นองศาเซลเซียสแล้วเป็นหน่วยที่ต้องการต่อ
```
