...
```text
โจทย์ให้คะแนนนั้นสามารถให้ได้ตั้งแต่ 0 ถึง 10 คะแนน ถ้าคะแนนโหวดของคนที่ให้คะแนนสูงสุด และคะแนนต่ำสุดห่างกันเกินสองคะแนน จะทำให้คนมาดูคะแนนรู้สึกประหลาดใจ (Surprising) ระบบเว็ปจึงต้องมีการแจ้งว่า มีโอกาสที่จะเกิด Surprising หรือไม่

Input:
โปรแกรมรับคะแนน รวมและมากที่สุด

Output:
โปรแกรมให้คะแนนโหวดของคนที่ให้คะแนนสูงสุด และคะแนนต่ำสุดห่างกันเกินสองคะแนน จะทำให้มีการแจ้งว่า มีโอกาสที่จะเกิด Surprising หรือไม่ที่หน้ารีวิว
```
...
```text
Step 1: รับค่าคะแนนรวม และคะแนนที่มากที่สุด
Step 2: นำค่าทั้งหมดลบค่ามากสุดจะได้ค่าที่เหลือ
Step 3: หาค่าที่น้อยสุดโดยการนำค่าที่เหลือลบค่า max และใช้คำสั่ง max ให้เลขไม่ติดลบ
Step 4: ถ้า max-min เกิน 2 print surprise 
```
