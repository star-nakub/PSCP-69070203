...
```text
โจทย์ให้เขียนโปรแกรมเพื่อรับค่าจำนวนเต็มบวก 1 จำนวน (N) จากนั้นหาว่าจำนวนเต็มบวกตั้งแต่ N ถึง 0 มีตัวเลขใดบ้างที่หารด้วย 10 ลงตัว และให้แสดงตัวเลขเหล่านั้นทางหน้าจอ

Input:
โปรแกรมรับจำนวนเต็มหนึ่งค่า n

Output:
แสดงจำนวนเต็มบวกตั้งแต่ N ถึง 0 ที่หารด้วย 10 ลงตัว
...
Step 2: ทำ loop จำนวน x ครั้ง
Step 3: ทุกกรณีตรวจว่า i หาร 10 ถ้าไม่มีเศษให้ print จำนวนนั้นๆ
Step 4: หลัง print ให้ไม่ต้องขึ่นบรรทัดใหม่
```
